...
GO
ALTER TABLE [B2B].[ExchangeDefinition] WITH NOCHECK
...
GO
ALTER TABLE [Data].[DataTerm] WITH NOCHECK
...
GO
ALTER TABLE [IdBase].[IdBaseTypeExtensions] WITH NOCHECK
...
GO
ALTER TABLE [Reference].[ReferenceObjects] WITH NOCHECK
...
GO
ALTER TABLE [Reference].[ReferencePolicies] WITH NOCHECK
...
GO
ALTER TABLE [Reference].[ReferenceTraceLog] WITH NOCHECK
...
ALTER TABLE [Reference].[ReferenceObjects] WITH CHECK CHECK CONSTRAINT [fk_ReferenceObjectTypeNo];
...
ALTER TABLE [Reference].[ReferencePolicies] WITH CHECK CHECK CONSTRAINT [fk_ReferencePoliciesReference];
