...
GO
PRINT N'Creating Login [KifDbReader]...';
...
GO
PRINT N'Creating Login [KifDbWriter]...';


GO
CREATE LOGIN [KifDbWriter]
    WITH PASSWORD = N'mgdCkMj=z|6feNrlcncAshbnmsFT7_&#$!~<.cll:sniqbc@', SID = 0x028BE8293F9F5D4C9544A01B1FB88813, DEFAULT_LANGUAGE = [us_english];


GO
PRINT N'Creating Login [KifReader]...';


GO
CREATE LOGIN [KifReader]
    WITH PASSWORD = N'}mgdkjzF|fkeP|rlcn;c zsSmsFT7_&#$!~<h$brnBlWlsni', SID = 0x031798BEF2053F4A9F9C2761A45E6628, DEFAULT_LANGUAGE = [us_english];


GO
PRINT N'Creating Login [KifReportReader]...';


GO
CREATE LOGIN [KifReportReader]
    WITH PASSWORD = N'm1g=dkjz2|1O||ferl^c0ngcmsFT7_&#$!~<s!hbnllvsgn^', SID = 0x80E03F98FB32974E91D387B7E5DD9A38, DEFAULT_LANGUAGE = [us_english];
...
GO
PRINT N'Creating Role Membership [db_datareader] for [KifDbReader]...';
...
GO
PRINT N'Creating Role Membership [db_datareader] for [KifDbWriter]...';
...
GO
PRINT N'Creating Role Membership [db_datawriter] for [KifDbWriter]...';
