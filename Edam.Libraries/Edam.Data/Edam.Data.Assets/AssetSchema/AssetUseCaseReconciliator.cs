...
namespace Edam.Data.AssetSchema
{
   ...
   public class AssetUseCaseReconciliator
   {
      ...
      private IAsset GetElement(string entityQualifiedNameText,
         string elementQualifiedNameText)
      {
         ...
         IAsset type = tlist[0] as IAsset;

         return type;
      }

      private IAsset GetTypeElement(string entityQualifiedNameText,
         string elementQualifiedNameText)
      {
      ...
      {
         IAsset property = GetProperty(entityQualifiedNameText);
      ...
      {
         // fetch ... register visited property
         IAsset property = GetProperty(element.ElementQualifiedName.Name);
      ...
      private void ProcessElement(AssetDataElement element)
      {
         ...
         element.DataType = asset.DataType;
         element.SetOccurance(asset.Occurs);
      }
