...
namespace Edam.Json.JsonSchemaReader
{
   ...
   public class JsonItemInfo : AssetElementInfo<JToken>, IAsset
   {
         ...
         JsonAssetItemInfo assets = null)
      {
         ...
         if (ElementType == Data.Asset.ElementType.type)
         {
         ...
         else if (ElementType == Data.Asset.ElementType.element)
         {
         ...
         {
            a.Annotation.Add(Edam.Text.Convert.ToTitleCase(
      ...
      private static Boolean IsReference(JProperty property)
      {
         if (property == null)
            return false;
      ...
      private static new Boolean IsType(JProperty property)
      {
         if (property == null)
            return false;
      ...
      private static Boolean IsDescription(JProperty property)
      {
         if (property == null)
            return false;
      ...
      public void AddProperty(JProperty property, JsonItemInfo item)
      {
         ...
         switch (property.Value.Type)
         {
            ...
            default:
               ...
               i.ElementType = Data.Asset.ElementType.element;
      ...
      private void SetFormat(string formatName, JsonItemInfo item)
      {
         ...
         if (r != Data.Asset.ElementType.undefined)
         {
         ...
         JsonItemInfo item, String typeName)
      {
         ...
         item.ElementType = (grp == Data.Asset.ElementType.element) ?
            grp : Data.Asset.ElementType.type;
         ...
         JProperty property, JsonItemInfo item)
      {
         ...
         JsonItemInfo i = new JsonItemInfo(property, item.Namespaces)
         {
            ElementType = Data.Asset.ElementType.enumerator,
