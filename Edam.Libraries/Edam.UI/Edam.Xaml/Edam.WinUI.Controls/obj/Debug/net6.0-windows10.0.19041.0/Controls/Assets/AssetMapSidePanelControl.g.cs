#pragma checksum "C:\prjs\Datovy.Edam\Edam.Libraries\Edam.UI\Edam.Xaml\Edam.WinUI.Controls\Controls\Assets\AssetMapSidePanelControl.xaml" "{8829d00f-11b8-4213-878b-770e8597ac16}" "624B63E8595E1B552E09AB4085730C7453D55F7EB568472305B093DA2BBD8271"
//------------------------------------------------------------------------------
// <auto-generated>
            ...
            IAssetMapSidePanelControl_Bindings
        {
            ...
            private void Update_ViewModel(global::Edam.WinUI.Controls.ViewModels.DataMapSidePanelViewModel obj, int phase)
            {
                ...
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | DATA_CHANGED | (1 << 0))) != 0)
                    {
                        this.Update_ViewModel_Expander(obj.Expander, phase);
                        this.Update_ViewModel_SelectedBooklet(obj.SelectedBooklet, phase);
                        this.Update_ViewModel_MapItemDescription(obj.MapItemDescription, phase);
                        this.Update_ViewModel_MapItemInstructions(obj.MapItemInstructions, phase);
            ...
            private void Update_ViewModel_Expander(global::Edam.WinUI.Controls.Utilities.ExpanderModel obj, int phase)
            {
                this.bindingsTracking.UpdateChildListeners_ViewModel_Expander(obj);
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | DATA_CHANGED | (1 << 0))) != 0)
                    {
                        this.Update_ViewModel_Expander_PanelVisibility(obj.PanelVisibility, phase);
                        this.Update_ViewModel_Expander_SelectedChevron(obj.SelectedChevron, phase);
                    }
                }
            }
            private void Update_ViewModel_Expander_PanelVisibility(global::Microsoft.UI.Xaml.Visibility obj, int phase)
            {
            ...
            private void Update_ViewModel_Expander_SelectedChevron(global::System.String obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED | DATA_CHANGED)) != 0)
                {
            ...
            private void Update_ViewModel_MapItemDescription(global::System.String obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED | DATA_CHANGED)) != 0)
                {
            ...
            private void Update_ViewModel_MapItemInstructions(global::System.String obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED | DATA_CHANGED)) != 0)
                {
            ...
            private void UpdateTwoWay_2_Visibility()
            {
                if (this.initialized)
                {
                    if (this.dataRoot != null)
                    {
                        ...
                        {
                            if (this.dataRoot.ViewModel.Expander != null)
                            {
                                this.dataRoot.ViewModel.Expander.PanelVisibility = this.obj2.Visibility;
                            }
                        }
                    }
                }
                ...
                if (this.initialized)
                {
                    if (this.dataRoot != null)
                    {
                        if (this.dataRoot.ViewModel != null)
                        {
                            if (this.dataRoot.ViewModel.Expander != null)
                            {
                                this.dataRoot.ViewModel.Expander.SelectedChevron = this.obj4.Glyph;
                            }
                        }
                    }
                }
            ...
            private void UpdateTwoWay_7_Text()
            {
                if (this.initialized)
                {
                    if (this.dataRoot != null)
                    {
                        if (this.dataRoot.ViewModel != null)
                        {
                            this.dataRoot.ViewModel.MapItemDescription = this.obj7.Text;
                        }
                    }
                }
            }
            private void UpdateTwoWay_8_Text()
            {
                if (this.initialized)
                {
                    if (this.dataRoot != null)
                    {
                        if (this.dataRoot.ViewModel != null)
                        {
                            this.dataRoot.ViewModel.MapItemInstructions = this.obj8.Text;
                        }
                    }
                }
            }
            ...
            private class AssetMapSidePanelControl_obj1_BindingsTracking
            {
                ...
                public void ReleaseAllListeners()
                {
                    ...
                    UpdateChildListeners_ViewModel_Expander(null);
                ...
                public void PropertyChanged_ViewModel(object sender, global::System.ComponentModel.PropertyChangedEventArgs e)
                {
                    ...
                    if (bindings != null)
                    {
                        ...
                        if (global::System.String.IsNullOrEmpty(propName))
                        {
                            if (obj != null)
                            {
                                bindings.Update_ViewModel_Expander(obj.Expander, DATA_CHANGED);
                                bindings.Update_ViewModel_SelectedBooklet(obj.SelectedBooklet, DATA_CHANGED);
                                bindings.Update_ViewModel_MapItemDescription(obj.MapItemDescription, DATA_CHANGED);
                                bindings.Update_ViewModel_MapItemInstructions(obj.MapItemInstructions, DATA_CHANGED);
                ...
                public void PropertyChanged_ViewModel_Expander(object sender, global::System.ComponentModel.PropertyChangedEventArgs e)
                {
                    AssetMapSidePanelControl_obj1_Bindings bindings = TryGetBindingObject();
                    if (bindings != null)
                    {
                        ...
                        if (global::System.String.IsNullOrEmpty(propName))
                        {
                            if (obj != null)
                            {
                                bindings.Update_ViewModel_Expander_PanelVisibility(obj.PanelVisibility, DATA_CHANGED);
                                bindings.Update_ViewModel_Expander_SelectedChevron(obj.SelectedChevron, DATA_CHANGED);
                            }
                        }
                        else
                        {
                ...
                private global::Edam.WinUI.Controls.Utilities.ExpanderModel cache_ViewModel_Expander = null;
                public void UpdateChildListeners_ViewModel_Expander(global::Edam.WinUI.Controls.Utilities.ExpanderModel obj)
                {
                    if (obj != cache_ViewModel_Expander)
                    {
                        if (cache_ViewModel_Expander != null)
                        {
                            ((global::System.ComponentModel.INotifyPropertyChanged)cache_ViewModel_Expander).PropertyChanged -= PropertyChanged_ViewModel_Expander;
                            cache_ViewModel_Expander = null;
                        }
                        if (obj != null)
                        {
                            cache_ViewModel_Expander = obj;
                            ((global::System.ComponentModel.INotifyPropertyChanged)obj).PropertyChanged += PropertyChanged_ViewModel_Expander;
                        }
                    }
                }
