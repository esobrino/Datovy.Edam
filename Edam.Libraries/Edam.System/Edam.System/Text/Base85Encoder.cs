...
namespace Edam.Text
{
   ...
   {
      /// <summary>
      /// Prefix mark that id an encoded ASCII85 string, traditionally '<~'
      /// </summary>
      public string PrefixMark = "<~";
      /// <summary>
      /// Suffix mark that id an encoded ASCII85 string, traditionally '~>'
      /// </summary>
      ...
      /// <summary>
      /// Add the Prefix and Suffix marks when encoding,
      /// and enforce their presence for decoding
      /// </summary>
      ...
      public byte[] Decode(string s)
      {
         if (EnforceMarks)
         {
            ...
            {
               throw new Exception(
                  "ASCII85 encoded data should begin with '" + PrefixMark +
         ...
         foreach (char c in s)
         {
            switch (c)
            {
               case 'z':
                  ...
                  {
                     throw new Exception(
                        "The char 'z' is invalid inside an ASCII85 block.");
                  }
                  _decodedBlock[0] = 0;
                  _decodedBlock[1] = 0;
                  _decodedBlock[2] = 0;
